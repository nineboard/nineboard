...
class AdvisorCollectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testPutDuplicateAdvisorName()
    {
        ...
        $advisor2 = new Advisor(
            'ad1',
            ['Xpressengine\Tests\Interception\Document@insertDocument', 'Xpressengine\Tests\Interception\Document@deleteDocument'],
            function ($target, $args) {
                return $target($args);
            }
        );
    ...
    public function testPutAndGetAdvisorList()
    {
        ...
        $advisor3 = new Advisor(
            'ad3',
            'Xpressengine\Tests\Interception\Document@deleteDocument',
            function ($target, $args) {
                return $target($args);
            }
        );
